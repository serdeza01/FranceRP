...
module.exports = {
  ...
  async execute(interaction, { staffStatus, updatePresenceEmbed, CHANNEL_ID, STAFF_ROLE_ID }) {
    ...
    return interaction.reply({ content: `Vous êtes maintenant marqué comme ${status}.`, ephemeral: true });
  }
};
